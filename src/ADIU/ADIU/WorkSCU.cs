...
namespace ADIU
{
    ...
    */
    ...
    /// <summary> Modality Worklist SCU Sample application class. </summary>
        ...
        */
        ...
        public static void getList(String[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("THIS: " + MC.mcIsInitialized());
            }
        ...
        /// <summary>  Displays the main menu to the user and then prompts them for input.
        /// </summary>
        /// <returns> inputLine
        /// </returns>
        ...
        {
            Util.println("\n\n\n\n\n\n\n\n\n\n");
            Util.println(" ** MODALITY WORKLIST SEARCH **\n");
            Util.println("Enter the number of the value to modify,");
            Util.println("followed by the value that you wish to set.");
            Util.println(" e.g.:  1 CT\n");
            Util.println("[1] Modality                   [" + modality + "]");
            Util.println("[2] Station Application Title  [" + aeTitle + "]");
            Util.println("[3] Patient Name               [" + patientName + "]");
            Util.println("[4] Procedure Start Date       [" + startDate.ToString() + "]");
            Util.println("[5] Reply message cut-off threshold  [" + threshold + "]");
            Util.println("[6] STAT Procedure (MPPS without WORKLIST)");
            Util.println("[Q] Perform a query");
            Util.println("[X] Exit");
            Util.println("");
            Util.print("==> ");
